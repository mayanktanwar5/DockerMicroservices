...
var conPool = mysql.createConnection({
	...
	host : config.db.host, //host where mysql server is running
	user : config.db.user, //user for the mysql application
	database : config.db.database,
	password : config.db.password, //password for the mysql application
	port : config.db.port//port, it is 3306 by default for mysql
